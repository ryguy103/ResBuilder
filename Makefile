# ============================================================================
# ResBuilder Makefile - AI-Powered Resume & Cover Letter System
# ============================================================================
...
help: ## Show this help
	@echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
	@echo "ResBuilder - AI-Powered Resume System"
	@echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
	@echo ""
	@echo "QUICK START:"
...
save: | $(OUTPUT_DIR) ## Save dated plain text copy to output/
	@cp resume.txt $(OUTPUT_DIR)/$(DATE_PREFIX)--resume.txt
	@cp resume.md $(OUTPUT_DIR)/$(DATE_PREFIX)--resume.md
	@echo "✓ Saved to $(OUTPUT_DIR)/"
	@echo "  - $(DATE_PREFIX)--resume.txt"
	@echo "  - $(DATE_PREFIX)--resume.md"
...
pdf: | $(OUTPUT_DIR) ## Build resume PDF (requires LaTeX)
	...
	@mv resume.pdf $(OUTPUT_DIR)/$(DATE_PREFIX)--resume.pdf
	@echo "✓ Resume: $(OUTPUT_DIR)/$(DATE_PREFIX)--resume.pdf"
...
cover: | $(OUTPUT_DIR) ## Build cover letter PDF (requires LaTeX)
	...
	@mv cover-letter.pdf $(OUTPUT_DIR)/$(DATE_PREFIX)--cover-letter.pdf
	@echo "✓ Cover letter: $(OUTPUT_DIR)/$(DATE_PREFIX)--cover-letter.pdf"
