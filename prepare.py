...
def read_master_resume():
    """Read the master resume content"""
...
def answer_questions_with_ai(questions: list, master_resume: str, job_description: str, company: str, role: str, interactive: bool = False) -> list:
    ...
    # Build base context once (shared across all questions)
    base_context = f"""CANDIDATE: Ryan Laxson
COMPANY: {company}
ROLE: {role}

RESUME SUMMARY:
- 5+ years at Zapier (fully remote) in Support Operations & Automation
- Built IncidentBot (Slack app with Zendesk, PagerDuty, OpenAI integration)
- Reduced incident response from 90 min to 3 min
- Saved $250K/year through automated workflows
- Built dashboards in Databricks, Looker, Grafana
- Authored playbooks, governance models, training docs
- Cross-functional work with Support, Engineering, Product, GTM
- Personal projects: LLM prompt evaluation framework, multi-assistant AI chat platform
- Skills: Python, JavaScript, Zapier, Slack apps, SQL, OpenAI/Claude APIs
- Education: B.A. Communications, Boise State
...
def questions_only_mode():
    ...
    print("\n" + "=" * 60)
    print("LAXJOB - Application Questions Mode")
    print("=" * 60)
...
def main():
    ...
    print("\n" + "=" * 60)
    print("LAXJOB - Resume & Cover Letter Generator")
    print("=" * 60)
